...
Function::Function(const Function &fObj) {
    this->timeValues_ = fObj.timeValues_;
    this->fType_ = fObj.fType_;
    this->ampValues_ = fObj.ampValues_;
    this->miscValues_ = fObj.miscValues_;
}
